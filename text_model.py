...
class SelfAttention(nn.Module):
    def __init__(self, input_dim, head_size):
        ...
        self.output_projection = nn.Linear(head_size, input_dim, bias=False)  
...
generated_text = generate_text(model, start_token, max_length=100, dataset=dataset, temperature=1.0)
